...
struct DomainSlotStatus {
    ...
    DomainSlotRuntimeState state = DomainSlotRuntimeState::Unavailable;
...
struct DomainStatusSummary {
    ...
    uint16_t notWired = 0U;
    uint16_t hardwareMissing = 0U;
    uint16_t unavailable = 0U;
    uint16_t safetyBlocked = 0U;
};
...
constexpr const char* domainSlotRuntimeStateName(DomainSlotRuntimeState state)
{
    switch (state) {
        ...
        case DomainSlotRuntimeState::Disabled: return "disabled";
        case DomainSlotRuntimeState::NotWired: return "not_wired";
        case DomainSlotRuntimeState::HardwareMissing: return "hardware_missing";
        case DomainSlotRuntimeState::Unavailable: return "unavailable";
        case DomainSlotRuntimeState::SafetyBlocked: return "safety_blocked";
    }
    return "unavailable";
}
