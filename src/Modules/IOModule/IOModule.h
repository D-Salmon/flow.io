...
private:
    ...
    static_assert(ANALOG_CFG_SLOTS <= 32U, "I/O descriptor storage supports analog slots a00..a31");
    static_assert(DIGITAL_INPUT_CFG_SLOTS <= 16U, "I/O descriptor storage supports input slots i00..i15");
    static_assert(DIGITAL_CFG_SLOTS <= 16U, "I/O descriptor storage supports output slots d00..d15");
