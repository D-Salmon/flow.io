...
Le profil recommandé `Waveshare-ESP32-S3` est autonome et fonctionne sur un
seul ESP32-S3. Le dépôt conserve également l'architecture historique suivante,
composée de deux firmwares destinés à deux ESP32 distincts:
